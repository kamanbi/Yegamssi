...
class WeatherIconMapper {
  ...
  static WeatherVisualSpec specFor(
  ...
  static String localizedLabelFor(
    ...
    return switch (condition) {
      WeatherCondition.sunny =>
        isNight ? l10n.weatherConditionClearNight : l10n.weatherConditionSunny,
      WeatherCondition.partlyCloudy =>
        isNight
            ? l10n.weatherConditionPartlyCloudyNight
            : l10n.weatherConditionPartlyCloudy,
      ...
      WeatherCondition.slightRain => l10n.weatherConditionSlightRain,
      WeatherCondition.rainy => l10n.weatherConditionRain,
      WeatherCondition.heavyRain => l10n.weatherConditionHeavyRain,
      WeatherCondition.thunderstorm => l10n.weatherConditionThunderstorm,
      WeatherCondition.rainThunder => l10n.weatherConditionRainThunder,
      WeatherCondition.lightSnow => l10n.weatherConditionLightSnow,
      WeatherCondition.snowy => l10n.weatherConditionSnow,
      WeatherCondition.sleet => l10n.weatherConditionSleet,
      WeatherCondition.hot =>
        isNight ? l10n.weatherConditionHotNight : l10n.weatherConditionHot,
      WeatherCondition.coldWave => l10n.weatherConditionColdWave,
      WeatherCondition.unknown => l10n.weatherConditionUnknown,
    };
  }
