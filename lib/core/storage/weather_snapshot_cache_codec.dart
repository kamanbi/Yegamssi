...
class WeatherSnapshotCacheCodec {
  const WeatherSnapshotCacheCodec._();

  static Map<String, dynamic> toJson(WeatherEntity weather) {
    return {
  ...
  static WeatherCondition parseCondition(String? raw) {
